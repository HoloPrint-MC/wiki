# Hologram controls
In HoloPrint you have three ways to control the hologram: With UI controls, player controls, and armour stand controls.

> [!WARNING]
> UI controls and player controls may be unreliable, but [armour stand controls](#armour-stand-controls) will always work.  
...
## Player controls
For player controls with items, attack while holding the specific item to perform the action. Because of Bedrock Edition being Bedrock Edition, other player actions may also accidentally trigger the hologram control.
